...
if (isset($_POST['id'])) {
    ...
    $query = "SELECT * FROM zone_two WHERE id = {$id}";
...
if (isset($_POST['updatethis'])) {
    ...
    $query = "UPDATE zone_two SET player_name = '$player_name', club = '$club', goals = '$goals' WHERE id = $id ";
...
if (isset($_POST['deletethis'])) {
    ...
    $query = "DELETE FROM zone_two WHERE id = $id ";
    $result_set = mysqli_query($connect, $query);
